      ...
      <Group title="Технологии коммутации">
        <Div>
          <p>
            ...
            Технология коммутации - предназначена для организации совместного
            использования сетевых ресурсов, образованных в результате
            мультиплексирования. – это телекоммуникационная технология, при помощи которой:
1) занимаются каналы связи и 2) строятся сетевые соединения.
          ...
          <p>
            ...
            <br></br>
            Использование центров коммутации, реализующих технологии коммутации, позволяет получить экономически оправданные решения для сетей связи любой емкости.
            <br></br>
            Центры коммутации организуют	доступ	большой	группы пользователей  к	ограниченному количеству общих ресурсов, при	помощи которых	может быть построено ограниченное этим количеством число соединений.
           <br></br>
            Технологии коммутации логически сложны и их логика в части занятия и освобождения ресурсов РЕАЛИЗУЕТСЯ ПРОГРАММНЫМИ СРЕДСТВАМИ, в отличие от технологий передачи и мультиплексирования.
         <br></br>
         ПОСЛЕДСТВИЯ ИСПОЛЬЗОВАНИЯ ЦЕНТРОВ КОММУТАЦИИ ПРИ ПОСТРОЕНИИ СЕТИ:  <br></br>
1)	сети большой емкости приобретают многоуровневую иерархическую структуру;  <br></br>
2)	для выполнения функций занятия ресурсов сетевые центры должны получать адресную информа- цию о направлениях передачи данных. Эта служебная (управляющая) информация циркулирует в сети и «отнимает» у полезной информации сетевые ресурсы;
<br></br>3)	существует вероятность отказа или задержки передачи сообщений из-за перегрузки, поскольку пропускная способность сети меньше, чем количество данных, которое может быть одновременно заявлено для передачи информационными источниками.
          ...
          <p>
            ...
            <br></br>
            Три уровня иерархии.
Чем меньше емкость центров коммутации – тем больше уровней иерархии требуется для построения сети.
<br></br>
Принцип нумерации
отражает иерархический принцип построения сети:
<br></br>
...
номер телефона в городе
         ...
         3) ограниченное время ожидания - заявка теряется при превышении времени ожидания
          </p>
          ...
          <p>
            ...
            <br></br>
            К числу важных свойств коммутируемых соединений, которые устанавливаются
центрами коммутации, относятся: <br></br>
скорость передачи данных; <br></br>
направление соединения – симплексные, дуплексные, другие; <br></br>
топология соединения – точка-точка, точка-многоточка, многоточка-точка, многоточка-многоточка; <br></br>
однородность соединения – технологические, энергетические, логические и другие <br></br>
характеристики отдельных участков могут или не могу отличаться друг от друга; <br></br>
информационная безопасность соединения – потребность в регистрации и хране- нии передаваемых управляющих и пользовательских данных и параметров соединений; <br></br>
способ оплаты за соединение – плата за время существования соединения, за переданные данные, другое; <br></br>
требования к информационной технологии – ручная, электромеханическая, <br></br>
электронная, аналоговая, цифровая и другие технологии построения соединения; <br></br>
представление передаваемой информации – есть или нет ограничения на формат передаваемых данных; <br></br>
качество канала – вероятности отказа канала, искажения данных и другое; <br></br>
чувствительность к перегрузкам – механизмы защиты от избыточного трафика. <br></br>
Способность устанавливать соединения с затребованными пользователями свойствами и скоростями передачи данных – важная характеристика центра коммутации.
          ...
          <p>
            ...
            <br></br>
            Услуги TriplePlay инфокоммуникационных мультисервисных сетей
связаны с доставкой речи, видео и данных и при предоставлении разных услуг
обеспечивают разную скорость передачи данных за счет статистического уплотнения.
<br></br>
Для предоставления разных инфоуслуг требуется задействовать разные скорости.
Важная задача – предоставить в распоряжение пользователя канал связи с нужной ему скоростью передачи.
...
-	распределить между пользователями (их сообщениями) имеющиеся канальные ресурсы сети связи;  <br></br>
-	обеспечить требуемую скорость доставки данных между пользователями.  <br></br>
Внедрение той или иной технологии зависит от (1) информационного объема передаваемых
сообщений и (2) объема каналов связи, образованных при мультиплексировании.  <br></br>
ТЕХНОЛОГИЯ КОММУТАЦИИ КАНАЛОВ. Если информационные объемы
сообщений примерно равны объему каналов связи, то каналы целесообразно закреплять за сообщениями на все время соединения.
          ...
          <p>
            ...
            <br></br>
            ТЕХНОЛОГИЯ КОММУТАЦИИ СООБЩЕНИЙ. Если емкость каналов существенно больше емкости поступающих сообщений, то один канал целесообразно использовать для передачи большой группы сообщений. 
          </p>
          ...
          <p>
            ...
            <br></br>
            ТЕХНОЛОГИЯ КОММУТАЦИИ ПАКЕТОВ. Если объем сообщений имеет существенный разброс и может быть как больше, так и меньше объема каналов связи, то можно разделить каждое сообщение на относительно одинаковые блоки (пакеты) и передавать эти блоки по каналам связи независимо друг от друга. 
          </p>
          ...
          <p>
            ...
            <br></br>
            ПРОБЛЕМА 1. Сети отличаются технологиями: видом сообщений, сигналов, линий связи, способами образования каналов при мультиплексировании, методами коммутации и др.
            <br></br>
            ПРОБЛЕМА 2. Сети управляются разными администрациями.
            <br></br>
            Путь 1. Построить все сети по одинаковой технологии. Это сделает их совместимыми.
Так строятся телефонные сети.<br></br>
Путь 2. Изменить сети только в том, что касается их входов и выходов. Внутренние сетевые технологии пусть выбирает местная администрация.
          </p>
          ...
          <p>
            ...
            <br></br>
            1)	Экономия затрат при объединении сетей.
При взаимодействии объединяемые сети должны использовать технологию коммутации пакетов и дейтаграммный режим без установления соединения (IP – Internet Protocol). Этот протокол стремится обеспечить качество доставки, но не несет ответственности за выбранные маршруты и порядок доставки, задержки и потерю пакетов, за информаци- онную безопасность пользователей.
<br></br>2)	Единые стандарты взаимодействия.
Передача информации между объединенными сетями должна осуществляться при помощи блока данных стандартного формата (IP-пакет).<br></br>
3)	Единое адресное пространство.
Система адресации должна обеспечивать уникальными именами (IP-адресами) каждую из взаимодействующих сетей. Адресация внутри отдельных сетей устанавливается местной администрацией.<br></br>
4)	Добровольность объединения.
Любая сеть может быть подключена к объединенной сети только по инициативе своей
администрации.<br></br>
5)	Совместимость внешних и внутренних данных для всех сетей. Объединяемые се- ти не должны обрабатывать IP-пакет, но должны при передаче внутренних данных обес- печивать и передачу IP-пакета.
<br></br>6)	Качество и безопасность?
          ...
          <p>
            ...
            <br></br>
            Коммутация каналов предполагает закрепление за пользователями всех общесетевых ресурсов, необходимых для информационного взаимодействия, на все время взаимодействия.
            <br></br>В электромеханических сетях коммутация каналов реализуется в форме соединения электрических цепей для переноса энергии сигналов. <br></br>
В цифровых сетях – в форме переноса данных об энергии сигнала в дискретные моменты во временных
слотах.
          ...
          <p>
            ...
            <br></br>
            Абонентские линии подключены к гнездам многократного поля коммутаторов.
Телефонистки при помощи токопроводя- щих шнуров со штепселями на концах соединяют гнезда для передачи сигналов электросвязи в форме электрического тока, модулированного телефонами пользователей.
          ...
          <p>
            ...
            <br></br>
            - электромеханический коммутационный аппарат, применяемый в системах коммутации, автоматизации и управления технологическими процессами.
          </p>
          ...
          <p>
            ...
            <br></br>
            Машинные системы также построены на основе искателей, однако отличаются наличием общих управляющих устройств - регистров Они предназначены для приема номера вызываемого абонента, хранения, переработки и передачи этого номера в управляющие устройства искателей.
          ...
          <p>
            ...
            <br></br>
            В координатных системах коммутационное поле состоит из многозвенных блоков коммутации, имеющих несколько входов и выходов и управляемых коллективным управляющим устройством – маркером.
            Чем выше скорость работы маркера, тем большей емкости может быть коммутационный блок, которым он управляет. При недостаточной скорости маркера могут возникать задержки установления соединений в пределах блока.
          ...
          <p>
            ...
            <br></br>
            Сети связи, использующие аналоговые АТС получили название телефонных сетей общего пользования. ТФОП используют для передачи:<br></br>
-	информации пользователя – канал тональной частоты в спектре 0,3-3,4 КГц;<br></br>
-	сигналов сигнализации – посылки постоянного тока или переменного тока в спектре 0,3-3,4 КГц.<br></br>
Сети связи, использующие такие узлы коммутации, получили название цифровых сетей интегрального обслуживания.
          </p>
          ...
          <p>
            ...
            <br></br>
            СРП характеризуется: постоянной скоростью передачи, циклической структурой сигналов и поддержкой постоянного соединения. Трафик сетей с СРП создают услуги реального времени – телефония, звуковое вещание и др. Этот режим дол- жен удовлетворять жестким требованиям к сетевой синхронизации.
            <br></br>
            АРП характеризуется передачей информационных блоков, имеющих фиксированную структуру и, вообще говоря, переменный размер. Для идентификации блока необходимо формировать его служебные поля. Трафик сетей с АРП может не удовлетворять требованиям реального времени. В режиме АРП работают локальные и глобальные сети коммутации пакетов.
          </p>
          <br></br>
          <p>
            ...
            <br></br>
            При временной коммутации необходимо перенести данные из одного слота (временного положения) в другой.
            <br></br>
            Пространственная коммутация заключается в переносе информации из одного цифрового тракта в другой без изменения слота.
<br></br>
На практике применяют многозвенные пространственно-временные блоки коммутации, когда перенос информации проводится одновременно и в другой тракт и в другой слот.
<br></br>Они могут быть описаны сочетанием коммутаторов, используемых при аналоговой коммутации.
          </p>
          <br></br>
          <p>
            ...
            <br></br>
            Сетевой центр коммутации реализует процессы коммутации и состоит из исполнительной и управляющей систем: <br></br>
            исполнительная система обеспечивает реализацию телекоммуникационных процессов передачи, мультиплексирования и коммутации. К числу ее компонент относятся каналы и линии связи, оборудование коммутации, разнообразные элементы, согласующие энергетические параметры сигналов и т.п.;
            <br></br>управляющая система обрабатывает управляющую информацию и вырабатывает команды, в соответствии с которыми занимаются/освобождаются элементы исполнительной системы. Ее компонентами являются программы управления, компьютеры, реализующие эти программы, средства взаимодействия этих компьютеров и т.п.
          ...
          <p>
            ...
            <br></br>
            Коммутационное поле содержит два типа блоков коммутации SSW и GSW, в которые включены абонентские модули SUB и служебные комплекты (комплекты АОН и конференц-связи, генераторы тональных частот, линейные комплекты, многочастотные приемо-передатчики и приемники сигна- лов тонального набора).
          </p>
          <br></br>
          <p>
            ...
            <br></br>
            Основой конфигурации системы является ЦКП, которое используется для коммутации как инфор- мации пользователей, так и сообщений между УУ. К ЦКП подключаются терминальные (ТМ) и системные (СМ) модули, имеющие собственное УУ, комплект программного обеспечения и стан- дартизованный аппаратно-программный интерфейс для связи с другими модулями. ТМ содержат оконечное оборудование, предназначенное для взаимодействия с источниками нагрузки, и осуще- ствляют управление установлением соединений в ЦКП. СМ не имеют оконечного терминального оборудования и выполняют функции, общие для группы однотипных терминальных модулей или
для всего центра.
          ...
          <p>
            ...
            <br></br>
            не предполагает закрепления за пользователем канальных ресурсов, поскольку информационная емкость сообщений меньше, чем емкость каналов связи. <br></br>
Пришедшее на центр коммутации сообщение должно сопровождаться адресной информацией и сначала сохраняется в специальной памяти, и лишь затем, после определения направления связи, ставится в очередь. Передача осуществляется после того, как будет сформирована группа из нескольких сообщений, совместная емкость которых соответствует емкости каналов связи.
<br></br>Передача сообщения, таким образом, осуществляется не в ре- альном масштабе времени, а по мере поступления других сообщений и освобождения каналов.
...
почтовых и телеграфных сетей.
          ...
          <p>
            ...
            <br></br>
            SMS-сообщение, используя те же сетевые ресурсы, что и голосовой сигнал, по каналам связи и центры коммутации доставляется до центра обработки SMS-сообщений, а затем в обратном направлении до терминала получателя.
          </p>
...
1)	разбивается на части (блоки данных) одинаковой или разной длины;   <br></br>
...
<br></br>3)	передача блоков данных происходит по технологии коммутации сообщений и в общем
случае может осуществляться через разные соединения (каналы связи).   <br></br>
4)	после поступления блоков данных на приемную сторону сообщение восстанавливает- ся и передается адресату.
          ...
          <p>
            ...
            <br></br>
            Дейтаграммный способ передачи данных основан на том, что все передаваемые пакеты обрабатываются независимо друг от друга. Выбор интерфейса, на который надо передать поступивший пакет, происходит только на основании адреса назначения, содержащегося в заголовке пакета. Принадлежность пакета к определенному информационному потоку никак не учитывается.
          </p>
...
получателя.
          ...
          <p>
            ...
            <br></br>
            В системах с многоскоростной коммутацией каналов за одним соединением может одновременно закрепляться несколько цифровых каналов, что позволяет изменять скорость переноса. Основная проблема – это сложность синхронизации компонент информационного потока, передаваемых по разным каналам
 <br></br>
 При быстрой коммутации каналов ресурсы в сети занимаются только на время передачи информации. Основная трудность заключается в реализации управляющей системы, которая должна устанавливать и разъединять соединения между пользователями за очень короткий интервал времени
          </p>
          ...
          <p>
            ...
            <br></br>
            Главное достоинство ATM и IP/MPLS – это возможность поддержки любых инфоуслуг независимо от требуемой им скорости передачи данных.
          </p>
        </Div>
      </Group>
      <br></br>
