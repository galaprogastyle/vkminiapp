        ...
        <Div>
          <p>
            <a name="bi1" style={{ color: "red" }}>
              1. Классификация базовых сетевых технологий. Принципы построения технологий передачи сигналов, мультиплексирования и коммутации.
              <br></br>
              2. Физический уровень IEEE 802.x. Спектр сигнала. Технологии расширения спектра. Модуляция и манипуляция.
            </a>
            <br></br>
            1.
            <br></br>
            1)Технологии передачи данных - обеспечивает перемещение данных в
            пространстве от отправителя к получателю. (физ. процесс - электромагнитное воздействие).
            <br></br>
            Линия связи - это совокупность физической среды и технических устройств, обеспечивающих передачу сигналов. Проводные (определенные характеристики), беспроводные (зависят от природы).
            Симметричный кабель, коаксиальный кабель, электропровода, волоконно-оптический кабель, линии радиосвязи(радиоволны).
            <br></br>
            ...
            <br></br>- получатели на приемной стороне при помощи демультиплексора
            ...
            мультиплексирования.
            <br></br>
            - телекоммуникационная технология, с помощью которой 1) занимаются каналы связи и 2) строятся сетевые соединения. Центры коммутации. Адресная информация занимает часть сетевых ресурсов.
            <br></br>
            2. 
            <br></br>
            Физический уровень 802.x. управляет формированием и передачей битов данных по физической среде - кабелю или эфиру. Здесь стандартизируются частотные диапазоны, скорости передачи данных, параметры среды передачи, уровни сигналов. Важная функция - физическое кодирование данных и побитовая синхронизация.
            <br></br>МОДУЛЯЦИЯ– это операция изменения параметров электромагнитного колебания (частоты, амплитуды и (или) фазы) в соответствии с передаваемым сообщением. В результате модуляции образуется сигнал, который переносит информацию. Теория Фурье позволяет разложить сигнал на ряд синусоид (гармоник), отличающихся своими параметрами. 
          ...
          <p>
            <a name="bi2" style={{ color: "red" }}>
              1.Основы технологий частотного мультиплексирования. Технология ADSL.  2.Технологии дальнего радиуса действия (LPWAN). LoRaWAN. "СТРИЖ".
            </a>
            <br></br>
            1.
            <br></br>
            Мультиплексирование с разделением по частоте FDM - электромагнитные колебания, частоты которых отличаются на достаточно большую величину, энергетически не взаимодействуют друг с другом, распространяясь в одной и той же физической среде.
            Предполагает, что каналы занимают относительно узкие частотные полосы в отведенных для них частотных диапазонах. Каждый входной сигнал накладывается на частоту своего канала(несущая), поэтому не перекрывается с другими входными сигналами. Фильтрация - выделение определенного сигнала.
            Для реализации нужны генераторы и фильтры. 
            <br></br>ADSL (модемная технология) - асинхронная цифровая линия, в которой каналы для приема данных имеют более высокую скорость, чем каналы для передачи данных. Плюс - можно использовать старую медную инфраструктуру на абонентском участке. Передача сигналов реализуется при помощи модема, и мультиплексора DSLAM - находится на АТС. 0.3-3.4кГЦ - телефонный сигнал. 26кГЦ-1.1МГЦ - цифровые данные. фильтр- частотный разделитель (голос - низкочастотные, данные - высокочастотные.)Исходящие - низкие частоты, входящие - высокие.
          <br></br>2.
          <br></br>/// LPWAN (low power wide-area network) - энергоэффективная сеть дальнего радиуса действия. - технология передачи небольших по обьему данных на дальние расстояния, разработанная для интернета вещей.
          <img src={img2} />
          <br></br>LoRaWAN использует топологию звезда для связи удаленных конечных узлов сенсорной сети, имеющих батарейное питание, со шлюзом.
          </p>
          <br></br>
          <p>
